...
char*  str_cin                ();                                           // ввод строки (создание и возврат указателя)
void   str_cin                (char*& str);                                 // ввод строки (работа с переданым указателем)
...
int    str_compare            (char* left, char* right);                    // сравнить строки посимвольно в алфавитном порядке
